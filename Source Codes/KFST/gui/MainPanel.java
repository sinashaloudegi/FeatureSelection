...
import KFST.featureSelection.wrapper.PSO4_2.PSO4_2Main;
...
//                    + "   q0 = " + q0);
    ...
    private void btn_moreOpWrapperActionPerformed(ActionEvent e) {
        ...
        if (cb_wrapper.getSelectedItem().equals("GeneticAlgorithm")) {
            ...
            Dialog psoDialog = new Dialog(psoPanel);
            psoPanel.setUserValue(numSwarmPopulation, numIterates);
        ...
        } else if (cb_wrapper.getSelectedItem().equals("GWO")) {
            GWOPanel gwoPanel = new GWOPanel();
            Dialog psoDialog = new Dialog(gwoPanel);
            gwoPanel.setUserValue(numSwarmPopulation, numIterates);
            gwoPanel.setVisible(true);
            numSwarmPopulation = gwoPanel.getNumSwarmPopulation();
            ...
            numIterates = bpsoPanel.getNumIterates();
        } else if (cb_wrapper.getSelectedItem().equals("PSO4_2")) {
            PSO4_2Panel pso4_2Panel = new PSO4_2Panel();
            Dialog psoDialog = new Dialog(pso4_2Panel);
            pso4_2Panel.setUserValue(numSwarmPopulation, numIterates);
        ...
        if (numSwarmPopulation == 0) {
            ...
            for (int i = 0; i < numRuns; i++) {
                ...
                for (int j = 0; j < numSelectedSubsets.length; j++) {
                    ...
                    BPSOMain method = new BPSOMain(numSelectedSubsets[j], numSwarmPopulation, numIterates);
        ...
        if (numSwarmPopulation == 0) {
            ...
            for (int i = 0; i < numRuns; i++) {
                ...
                for (int j = 0; j < numSelectedSubsets.length; j++) {
                    ...
                    PSO4_2Main method = new PSO4_2Main(numSelectedSubsets[j], numSwarmPopulation, numIterates);
        ...
        if (numSwarmPopulation == 0) {
            ...
            for (int i = 0; i < numRuns; i++) {
                ...
                for (int j = 0; j < numSelectedSubsets.length; j++) {
                    ...
                    GWOMain method = new GWOMain(numSelectedSubsets[j], numSwarmPopulation, numIterates);
