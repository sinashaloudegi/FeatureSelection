 ...
 */
public class IRRFSACO_2Panel extends JDialog
    ...
    public IRRFSACO_2Panel() {
        super();
        lbl_title = new JLabel("IRRFSACO_2 settings:");
        ...
        lbl_about = new JLabel("<html>Incremental relevance-redundancy feature selection based on ACO, version2 (IRRFSACO_2) is the modified version of the RRFSACO_2 in which a heuristic information measure is used to consider the similarity between subsets of features.</html>");
