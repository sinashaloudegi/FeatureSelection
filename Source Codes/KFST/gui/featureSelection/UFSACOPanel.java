 ...
 */
public class UFSACOPanel extends JDialog
    ...
    public UFSACOPanel() {
        super();
        lbl_title = new JLabel("UFSACO settings:");
        ...
        lbl_about = new JLabel("<html> Unsupervised feature selection based on ant colony optimization (UFSACO) is a multivariate filter method based on the ant colony optimization. The UFSACO performs an explicit redundancy analysis and implicit relevance analysis. </html> ");
        ...
        btn_ok.setBounds(190, 395, 75, 23);
        btn_ok.addActionListener(this);

        btn_more = new JButton("More");
        btn_more.setBounds(310, 395, 75, 23);
     ...
     * @param numbFeatureOfAnt the number of selected features by each ant in each iteration
