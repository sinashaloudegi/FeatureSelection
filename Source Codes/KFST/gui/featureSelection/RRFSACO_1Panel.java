 ...
 */
public class RRFSACO_1Panel extends JDialog
    ...
    public RRFSACO_1Panel() {
        super();
        lbl_title = new JLabel("RRFSACO_1 settings:");
        ...
        lbl_about = new JLabel("<html> Relevance-redundancy feature selection based on ACO, version1 (RRFSACO_1) is an unsupervised method that can handle both irrelevant and redundant features in an acceptable time. RRFSACO_1 uses the normalized values of the relevance values of the features as the initial intensity of pheromones.</html>");
