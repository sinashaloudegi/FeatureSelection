 ...
 */
public class IRRFSACO_1Panel extends JDialog
    ...
    private double defEvRate = 0.2, defBeta = 1, defQ0 = 0.7;
    ...
    public IRRFSACO_1Panel() {
        super();
        lbl_title = new JLabel("IRRFSACO_1 settings:");
        ...
        lbl_about = new JLabel("<html> Incremental relevance-redundancy feature selection based on ACO, version1 (IRRFSACO_1) is the modified version of the RRFSACO_1 in which a heuristic information measure is used to consider the similarity between subsets of features.  </html>");
        ...
        txt_numAnts = new JTextField(Integer.toString(defNumAnts));
        ...
        txt_numFeature = new JTextField(Integer.toString(defNumFeatOfAnt));
    ...
    public void keyReleased(KeyEvent e) {
        if (e.getSource().equals(txt_numIteration)) {
     ...
     * @param numberFeatureOfAnt the number of selected features by each ant in each iteration
